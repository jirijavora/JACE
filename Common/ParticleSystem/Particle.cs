...
public struct Particle {
    ...
    /// <summary>
    ///     The variant index of the particle texture
    /// </summary>
    ...
    /// </summary>
    public void Initialize(Vector2 where, int textureVariant, float lifetime = 1, float scale = 1, float rotation = 0,
        float angularVelocity = 0, float angularAcceleration = 0, bool active = true) {
        Position = where;
        ...
        Color = Color.White;
        Lifetime = lifetime;
        TimeSinceStart = active ? 0f : Lifetime;
    ...
    /// </summary>
    public void Initialize(Vector2 position, Vector2 velocity, int textureVariant, float lifetime = 1, float scale = 1,
        float rotation = 0,
        float angularVelocity = 0, float angularAcceleration = 0, bool active = true) {
        Position = position;
        Velocity = velocity;
    ...
    ///     Sets the particle up for first use
    /// </summary>
    public void Initialize(Vector2 position, Vector2 velocity, Vector2 acceleration, int textureVariant,
        float lifetime = 1,
        float scale = 1, float rotation = 0, float angularVelocity = 0, float angularAcceleration = 0,
        bool active = true) {
        Position = position;
        Velocity = velocity;
    ...
    ///     Sets the particle up for first use
    /// </summary>
    public void Initialize(Vector2 position, Vector2 velocity, Vector2 acceleration, Color color, int textureVariant,
        float lifetime = 1,
        float scale = 1, float rotation = 0, float angularVelocity = 0, float angularAcceleration = 0,
        bool active = true) {
        Position = position;
